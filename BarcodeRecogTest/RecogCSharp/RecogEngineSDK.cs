...
namespace RecogCSharp
{
    ...
    class RecogEngineSDK
    {
        const string DLL_NAME = "RecogEngine.dll";

        [DllImport(DLL_NAME, EntryPoint = "sv_engine_init", CharSet = CharSet.Ansi)]
        public static extern Int32 SvEngineInit();

        [DllImport(DLL_NAME, EntryPoint = "sv_engine_close", CharSet = CharSet.Ansi)]
        public static extern Int32 SvEngineClose();

        [DllImport(DLL_NAME, EntryPoint = "sv_engine_rec", CharSet = CharSet.Ansi)]
        public static extern Int32 _SvEngineRec(byte[] buf, int _w, int _h, int _bpp, [Out] out IntPtr _outRes);

        [DllImport(DLL_NAME, EntryPoint = "sv_get_param", CharSet = CharSet.Ansi)]
        public static extern Int32 SvEngineGetParam(ref SvBarRecParams param);

        [DllImport(DLL_NAME, EntryPoint = "sv_set_param", CharSet = CharSet.Ansi)]
        public static extern Int32 SvEngineSetParam(ref SvBarRecParams param);

        public static Int32 SvEngineRec(Bitmap frame, ref CodeRecogRes[] _outRes)
        {
            ...
            Int32 iRes = _SvEngineRec(rgbValues, frame.Width, frame.Height, 24, out outArrayReceiver);
        ...
        public static Int32 SvEngineRecFromBuffer(byte[] _buf, int _w, int _h, ref CodeRecogRes[] _outRes)
        {
            IntPtr outArrayReceiver = IntPtr.Zero;

            Int32 iRes = _SvEngineRec(_buf, _w, _h, 24, out outArrayReceiver);
